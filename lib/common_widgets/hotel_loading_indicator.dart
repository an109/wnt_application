...
class HotelLoadingIndicator extends StatefulWidget {
  ...
  @override
  State<HotelLoadingIndicator> createState() => _HotelLoadingIndicatorState();
}

class _HotelLoadingIndicatorState extends State<HotelLoadingIndicator> {
  int _messageIndex = 0;
  Timer? _timer;
