...
class _VisaApplicationScreenState extends State<VisaApplicationScreen> with TickerProviderStateMixin {
  ...
  void _triggerCreateApplication() {
    ...
    final userId = prefs.getUserId().toString();
        ...
        builder: (context, child) {
          return Row(
            children: [
              ...
              _buildConnector(2),
              _buildStepItem(3, 'Upload Document', Icons.upload_file),
              _buildConnector(3),
              _buildStepItem(4, 'Make Payment', Icons.payment),
            ],
          );
        },
      ),
          ...
          children: [
            ...
            UploadDocumentsSection(
              ...
              onSubmit: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Documents uploaded! Please complete the payment.'),
                    backgroundColor: Color(0xff10B981),
                    behavior: SnackBarBehavior.floating,
                  ),
                );
            ...
            PaymentSection(
              ...
              onPaymentSuccess: _showSuccessDialog,
            ),
            SizedBox(height: context.h(12)),
            FareSummary(
