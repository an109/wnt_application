          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(fontSize: context.bodyLarge, fontWeight: FontWeight.w600, color: const Color(0xFFB8BEC9)),
                border: InputBorder.none,
                isDense: true,
                contentPadding: EdgeInsets.symmetric(vertical: context.h(4)),
              ),
              style: TextStyle(fontSize: context.bodyLarge, fontWeight: FontWeight.w800, color: const Color(0xFF071638)),
