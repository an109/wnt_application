...
class HotelFacilitiesSection extends StatefulWidget {
  final List<String> facilities;
  final String title;
  ...
  @override
  State<HotelFacilitiesSection> createState() => _HotelFacilitiesSectionState();
}

class _HotelFacilitiesSectionState extends State<HotelFacilitiesSection> {
  bool _isExpanded = false;
  static const int _previewItemCount = 8;
  ...
  Widget build(BuildContext context) {
    ...
    print('HotelFacilitiesSection: Building with ${widget.facilities.length} facilities');

    // Get visible facilities based on expanded state
    final visibleFacilities = _isExpanded
        ? widget.facilities
        : widget.facilities.take(_previewItemCount).toList();
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildFacilitiesGrid(context, visibleFacilities),

            // Add Read More / Read Less button if there are more facilities
            if (widget.facilities.length > _previewItemCount) ...[
              const SizedBox(height: 16),
              GestureDetector(
                onTap: () {
                  setState(() {
