...
class _HotelPaymentScreenState extends State<HotelPaymentScreen> {
  ...
  Future<void> _callBookApi(String razorpayPaymentId) async {
    ...
    final clientRef = '${DateTime.now().millisecondsSinceEpoch}';
  ...
  Future<void> _saveBookingToDb({
    ...
    try {
      ...
      await dio.post(Urls.hotelBookings, data: {
        ...
        'tbo_booking_id': widget.bookingCode,
    ...
    return _card(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(widget.hotelName, style: TextStyle(fontSize: context.titleMedium, fontWeight: FontWeight.w600)),
