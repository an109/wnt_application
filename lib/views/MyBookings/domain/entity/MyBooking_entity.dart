...
class BookingEntity extends Equatable {
  ...
  const BookingEntity({
    ...
    required this.bookedDate,
    required this.category,
    this.startAddress = '',              // NEW with default
    this.endAddress = '',                // NEW with default
    this.pickupDatetime = '',            // NEW with default
    this.flightNumber = '',              // NEW with default
    this.vehicleName = '',               // NEW with default
  });
